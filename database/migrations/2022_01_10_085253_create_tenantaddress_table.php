...
class CreateTenantaddressTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tenantaddress', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('tenant_site')->nullable();
            $table->string('tenant_street_no')->nullable();
    ...
    {
        Schema::dropIfExists('tenantaddress');
    }
}
